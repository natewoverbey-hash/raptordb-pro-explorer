...
const journeyStages = [
  ...
  { id: "pro", label: "RaptorDB Pro", subtitle: "True HTAP", icon: <ZapIcon size={28} />, color: C.wasabi,
    details: { title: "The Database for AI Agents, Reports & Workflows", points: ["Column-store index — reads only the data columns you need", "Parallel query processing — multiple queries simultaneously", "Run analytics on live operational data — no ETL needed", "Foundation for AI agents — speed and scale for agentic workloads", "SQL API for bring-your-own-BI — query ServiceNow data with tools you already use"], metric: { label: "Analytics", value: "27x faster", sub: "vs. MariaDB (TPC-H)" } }},
];
...
const htapFeatures = [
  ...
  { icon: <ServerIcon size={20} />, label: "SQL API & BYOBI", desc: "Connect Power BI, Tableau, or any JDBC/ODBC tool directly to ServiceNow" },
  { icon: <DatabaseIcon size={20} />, label: "Object Store", desc: "Petabyte-scale archiving with 50% compression — warm, queryable data" },
];
...
const useCases = [
  ...
  { id: "vuln-response", icon: <ShieldIcon size={32} />,
    ...
    after: { title: "With RaptorDB Pro",
      ...
      narrative: "Column-store index processes tens of millions of Vulnerable Items records in seconds — reading only the columns needed for risk scoring without scanning full rows. Parallel processing runs multiple vulnerability prioritization queries simultaneously. Security teams get real-time exploitability analysis on live data without exporting to external SIEM or analytics platforms. Historical vulnerability trending across years stays queryable via Object Store, supporting HIPAA audit requirements without performance degradation." },
    outcomes: [
    ...
    proExclusive: ["Column-Store on VI Tables", "Parallel Vulnerability Scoring", "Object Store for VI History"],
  },
];
